...
Just a shorcut, `r colors()` is equivalent to `r RColorBrewer::display.brewer.all()`. Setting *print = TRUE* will also print the names of all palettes in RColorBrewer. 
